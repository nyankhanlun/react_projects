            ...
            <main className="flex min-h-screen flex-col px-5 sm:px-10 py-5 bg-[#e1efff] dark:bg-black sm:items-start">
                ...
                <div className="flex flex-col md:flex-row w-full gap-3">
                  ...
                  text-left md:text-right font-medium">
                        <span className="text-[#d8675e]">Total - 101</span>
                    </div>

                    {/* Left section */}
                    <div className="order-2 md:order-1 flex flex-row items-center gap-4 w-full md:basis-1/2">
                        <p className="text-2xl whitespace-nowrap text-[#1f5692] font-semibold">Artist - David Lah</p>
                ...
                <div className="flex flex-col w-full pt-10 md:flex-row">
                    <div className="basis-1/2">
                        <ol className="list-decimal list-inside space-y-2 text-gray-800">
                            <li>
                                <Link href={`/details`}> အိုးထိန်းရှင်</Link>
                            </li>
                            {/* href={`/details/${1}` */}
                            <li>
                                <Link href={`/details`}>ထပ်ဆင့် ကျေးဇူးတော်</Link>
                            </li>
                            <li>ထိုသခင်နာမ</li>
                            <li>အိုးထိန်းရှင်</li>
                            <li>ကိုယ်တော်သာ</li>
